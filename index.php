...
{
	if($_SESSION['auth'] >90) // admin user 
	{
		$menu = "menu99.htm";
	}
	else   //normal user
	{
		if( $_SESSION['auth'] == 9)
			$menu = "menu20.php"; //This does nothing but I am too scared to delete it. Last time it somehow deleted all the menus? wut
		else
			$menu = "menu20.htm";
	}
}
else  //no session variable at all
{
		$menu = "menu0.htm";
}
...
echo "<head>";
	...
	echo "<title>Grace College Accounting Fair</title>";
echo "</head>";
